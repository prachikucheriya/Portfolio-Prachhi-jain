...
Today I specialize in RMS monitoring, IoT connectivity, and national portal synchronization aligned with India's PM Surya Ghar scheme — bridging DISCOM integrations, MSEDCL workflows, and real-world field operations.`,
  ...
  currentStatus:
    "My most recent role was as an IT Support Executive (RMS / national portal operations), which concluded in December 2025. I am now open to new opportunities and bring a strong grasp of both insurance underwriting principles and solar monitoring systems.",
  additionalContext: [
  ...
  experience: [
    ...
    {
      company: "PV Power Technologies Private Ltd",
      role: "IT Support Executive",
    ...
    },
    {
      ...
      highlights: [
        "Developed easy-to-use interfaces aligned with project and client specifications",
        "Designed logos, icons, images, and banners for websites",
        "Optimized website performance through cross-browser and device testing",
        "Handled multiple design tasks with strong attention to detail",
        "Collaborated independently and within teams with clear communication",
      ],
    },
    {
      ...
      highlights: [
        "Provided support and training to client users on the Solar Energy Data Management Platform (SEDM)",
        "Analyzed consumer and asset information for operations teams",
        "Verified and validated data and image discrepancies in JCR/PCR reports and escalated findings weekly/monthly",
        "Generated exception reports for complaint and ticket management against SLA response and resolution times",
        "Troubleshot RMS integration issues and maintained RMS connectivity",
        "Synced data with the national portal and managed portal tasks such as lot creation and device registration",
      ],
    },
    {
